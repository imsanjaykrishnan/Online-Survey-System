...
public class four extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == que) {
			JOptionPane.showMessageDialog(four.this, "Question added successfully" + " to the database", " ",
		...
		if (e.getSource() == cancel) {
			JOptionPane.showMessageDialog(four.this, "Recent question has been deleted from Database", " ",
					JOptionPane.INFORMATION_MESSAGE);
			try {
				Class.forName("com.mysql.cj.jdbc.Driver"); // step1
				// step2
		...
		if (e.getSource() == dl) {
			JOptionPane.showMessageDialog(four.this, "All question has been deleted from Database", " ",
					JOptionPane.INFORMATION_MESSAGE);
			try {
				Class.forName("com.mysql.cj.jdbc.Driver"); // step1
		...
		if (e.getSource() == submit) {
			JOptionPane.showMessageDialog(four.this, "All question has been added to the Database", " ",
					JOptionPane.INFORMATION_MESSAGE);
			this.dispose();
		}
	}
